...
y_pred2a = classifier.predict(yo)

for x in range(len(y_pred2a)):
    if(y_pred2a[x]<0.5):
        y_pred2a[x]=0
...
####### best_parameters={'batch_size': 25, 'nb_epoch': 500, 'optimizer': 'adam'}
##therefore changing these in our NN
